...
export default function QuestionPage() {
  const faqs = [
    ...
    {
      question: '車検は数日間預ける必要がありますか。その日のうちに返却してもらうことはできますか。忙しくて何度も来店できません。一度で完了させることは可能ですか。',
      answer: [
        {
          content: '当日中のご返却にも対応しております。\n当社では1日車検にも対応しており、指定工場の場合は最短1時間で車検を完了することも可能です。\nお忙しいお客様でも、できる限り一度のご来店で完了できるよう配慮いたします。\n\nなお、ご入庫時の混雑状況や追加整備の有無によっては、返却時間の調整をお願いする場合がございます。あらかじめご了承ください。'
        }
      ]
    }
  ];
