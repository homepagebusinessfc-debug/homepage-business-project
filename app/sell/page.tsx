          ...
          <div className="mt-12 pt-10 border-t border-gray-200">
            ...
            <form className="space-y-6">
              ...
              <div>
                ...
                <input
                  type="text"
                  className="w-full border rounded-lg px-4 py-3 shadow-sm focus:outline-none focus:ring-2 focus:ring-red-500"
                />
              </div>
              ...
              <div>
                <label className="block text-gray-700 font-semibold mb-2">
                  お電話番号 <span className="text-red-500 text-sm">必須</span>
                </label>
                <input
                  type="tel"
                  className="w-full border rounded-lg px-4 py-3 shadow-sm focus:outline-none focus:ring-2 focus:ring-red-500"
              ...
              <div>
                <label className="block text-gray-700 font-semibold mb-2">
                  車種・年式 <span className="text-red-500 text-sm">必須</span>
                </label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-gray-700 font-semibold mb-2">
                  走行距離 <span className="text-red-500 text-sm">必須</span>
                </label>
                <input
                  type="text"
              ...
              <div>
                ...
                <textarea
                  className="w-full border rounded-lg px-4 py-3 shadow-sm h-32 focus:outline-none focus:ring-2 focus:ring-red-500"
              ...
              <div className="text-center pt-4">
                <button
                  type="submit"
                  className="inline-block w-full md:w-auto px-12 py-4 bg-red-600 text-white text-lg font-bold rounded-full hover:bg-red-700 transition-colors shadow-lg"
                >
                  無料査定を申し込む
                </button>
              </div>
