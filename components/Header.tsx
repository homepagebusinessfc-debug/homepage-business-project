          ...
          <div className="max-w-[1600px] mx-auto w-full">
            ...
            <div className="flex flex-row flex-nowrap justify-center sm:justify-center items-center gap-2 sm:gap-3 lg:gap-6 xl:gap-8 relative">
              ...
              <button
                ...
                style={{ backgroundColor: 'rgba(255, 160, 0, 0.3)' }}
                onMouseEnter={(e) => e.currentTarget.style.backgroundColor = 'rgba(255, 160, 0, 0.5)'}
                onMouseLeave={(e) => e.currentTarget.style.backgroundColor = 'rgba(255, 160, 0, 0.3)'}
              >
